    ...
    try {
        ...
        for (const img of images) {
            ...
            const processImg = () => {
                ...
                // Only intercept images if this is a Browse Code chat
                if (!document.body.innerText.includes("CRITICAL OVERRIDE: You MUST use the custom XML tool tags")) return;
        ...
        for (const svg of svgs) {
            ...
            // Only intercept SVGs if this is a Browse Code chat
            if (!document.body.innerText.includes("CRITICAL OVERRIDE: You MUST use the custom XML tool tags")) {
                svg.dataset.agentProcessed = "true";
                continue;
            }
