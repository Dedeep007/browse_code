...
app.add_middleware(
    CORSMiddleware,
    allow_origin_regex=r"https://.*\.claudemcpcontent\.com|https://claude\.ai|https://gemini\.google\.com|https://chatgpt\.com|https://chat\.openai\.com|https://huggingface\.co|chrome-extension://.*|moz-extension://.*|edge-extension://.*|extension://.*|http://localhost:.*|http://127\.0\.0\.1:.*",
